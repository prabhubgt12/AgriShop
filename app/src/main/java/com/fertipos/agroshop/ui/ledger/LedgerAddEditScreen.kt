...
fun LedgerAddEditScreen(
    ...
    AlertDialog(
        ...
        confirmButton = {
            TextButton(onClick = {
                val entry = LedgerEntry(
                    ...
                    period = period, // Rate Basis for both types
                    compoundPeriod = compoundPeriod, // Duration Type for compound
        ...
        title = { Text(if (isEdit) "Edit Entry" else "Add to Book") },
        text = {
            Column(
                Modifier
                    .fillMaxWidth()
